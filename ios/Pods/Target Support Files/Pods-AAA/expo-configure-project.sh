...
with_node \
  ...
  --target "/Users/kantanka/Desktop/ReactProject/AAA/AAA/ios/Pods/Target Support Files/Pods-AAA/ExpoModulesProvider.swift" \
  --entitlement "/Users/kantanka/Desktop/ReactProject/AAA/AAA/ios/AAA/AAA.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
